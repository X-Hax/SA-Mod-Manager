...
# Debug/release flags.
SET(MODLOADER_C_FLAGS_DEBUG "-Od -MDd -RTC1 -Zi")
SET(MODLOADER_CXX_FLAGS_DEBUG "-Od -MDd -RTC1 -Zi")
SET(MODLOADER_EXE_LINKER_FLAGS_DEBUG "-DEBUG")
SET(MODLOADER_C_FLAGS_RELEASE "-O2 -MD -Zi")
SET(MODLOADER_CXX_FLAGS_RELEASE "-O2 -MD -Zi")
