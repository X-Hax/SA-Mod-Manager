...
SET(MODLOADER_C_FLAGS_WIN32 "-fshort-wchar -DSTRICT -D_WIN32_WINNT=0x0500")
...
# --tsaware is valid for EXEs only.
SET(MODLOADER_SHARED_LINKER_FLAGS_WIN32 "")
FOREACH(FLAG_TEST "-Wl,--tsaware")
	...
	CHECK_C_COMPILER_FLAG("${FLAG_TEST}" LDFLAG_${FLAG_TEST_VARNAME})
	IF(LDFLAG_${FLAG_TEST_VARNAME})
		SET(MODLOADER_SHARED_LINKER_FLAGS_WIN32 "${MODLOADER_SHARED_LINKER_FLAGS_WIN32} ${FLAG_TEST}")
	ENDIF(LDFLAG_${FLAG_TEST_VARNAME})
	UNSET(LDFLAG_${FLAG_TEST_VARNAME})
	UNSET(FLAG_TEST_VARNAME)
ENDFOREACH()
...
SET(MODLOADER_SHARED_LINKER_FLAGS_COMMON "${MODLOADER_SHARED_LINKER_FLAGS_COMMON} ${MODLOADER_EXE_LINKER_FLAGS_WIN32} ${MODLOADER_SHARED_LINKER_FLAGS_WIN32}")
