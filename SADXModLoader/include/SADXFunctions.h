...
FunctionPointer(char *, GetCharIDString, (), 0x422490);
...
FunctionPointer(void, DisplayHintText, (char **strings, int duration), 0x4B79C0);
...
FunctionPointer(void, DrawChaoHat, (ObjectMaster *a1, ChunkObjectPointer *a2), 0x73E730);
