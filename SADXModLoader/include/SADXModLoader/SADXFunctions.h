...
FunctionPointer(Characters, GetCurrentCharacterID, (void), 0x4144E0);
...
FunctionPointer(int, GoToNextLevel, (void), 0x414610);
FunctionPointer(int, GetPrevLevelAndAct, (void), 0x414670);
FunctionPointer(int, GetNextLevelAndAct, (void), 0x414690);
FunctionPointer(bool, IsLevelChaoGarden, (void), 0x4146B0);
FunctionPointer(int, SetLevelEntrance, (char num), 0x4147F0);
FunctionPointer(int, GetLevelEntranceID, (void), 0x414800);
FunctionPointer(void, SetNextLevel, (uint16_t level), 0x414B00);
FunctionPointer(bool, IsGamePaused, (void), 0x414D70);
...
FunctionPointer(bool, GetDebugMode, (void), 0x4258F0);
VoidFunc(Set0Rings, 0x425AB0);
FunctionPointer(int, GetMarketRings, (void), 0x425AC0);
FunctionPointer(int, ResetLives, (void), 0x425AF0);
FunctionPointer(void, GiveLives, (int16_t lives), 0x425B60);
FunctionPointer(void, AddRings, (int16_t rings), 0x425BE0);
FunctionPointer(int, GetRings, (void), 0x425CC0);
...
FunctionPointer(bool, IsTime0, (void), 0x426690);
...
FunctionPointer(bool, IsFastSonicAI, (void), 0x47C200);
FunctionPointer(void, SetTailsRaceVictory, (void), 0x47C450);
FunctionPointer(void, SetOpponentRaceVictory, (void), 0x47C460);
...
FunctionPointer(int, CountUnlockedCharacters, (void), 0x512C50);
...
FunctionPointer(char *, GetChaoSaveAddress, (void), 0x716FA0);
...
FunctionPointer(char *, GetWindowClassName, (void), 0x793F60);
