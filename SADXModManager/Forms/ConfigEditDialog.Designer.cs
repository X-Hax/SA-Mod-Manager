namespace SADXModManager.Forms
{
    partial class ConfigEditDialog
    {
        ...
        "and low for 15FPS.");
            ...
            this.toolTip_ConfigEditor.SetToolTip(this.numericBGMVol, "Controls the BGM and FMV volume");
            // 
            // numericSoundVol
            // 
            ...
            this.toolTip_ConfigEditor.SetToolTip(this.numericSoundVol, "Controls the volume of voices.\r\nSetting it to 0 also disables sound effects.");
            // 
            // label7
            // 
            ...
            this.Text = "Vanilla Configuration Editor";
